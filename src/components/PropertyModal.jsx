...
const PropertyModal = ({ property, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl w-full max-w-2xl relative overflow-hidden shadow-2xl"
      ...
      >
        ...
        {/* Imagen destacada */}
        <div className="relative h-64 bg-braidot-neutral-900">
          <img 
        ...
        {/* Footer con botones */}
        <div className="border-t border-braidot-neutral-200 p-4 bg-white">
