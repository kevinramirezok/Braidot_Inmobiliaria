        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a 
                href="https://facebook.com/braidotinmobiliaria" 
                target="_blank"
              ...
              <a 
                href="https://instagram.com/braidotinmobiliaria" 
                target="_blank"
                className="bg-white/20 hover:bg-white/30 rounded-full p-2 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/80">
              <li className="flex items-start gap-2">
                ...
                <span>Calle 38 n° 1375<br/>Reconquista, Santa Fe</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:inmobiliariabraidot@hotmail.com" className="hover:text-white">
                  inmobiliariabraidot@hotmail.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+543482305750" className="hover:text-white">
                  3482 305750
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              ...
              <li>
                <span className="font-semibold text-white">Primer sábado del mes</span>
                <br/>8:00 a 12 hs
              </li>
            </ul>
          </div>
