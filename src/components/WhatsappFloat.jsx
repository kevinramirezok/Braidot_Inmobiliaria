    ...
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      {showTooltip && (
        <div className="hidden md:block bg-white rounded-lg shadow-xl px-4 py-3 animate-bounce">
          <p className="text-sm font-semibold text-braidot-negro">
            ¿Necesitás ayuda? 💬
          </p>
      ...
      <button
        onClick={handleClick}
        className="bg-green-500 hover:bg-green-600 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-300 group relative"
