    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-8">
          <h2 className="text-2xl font-bold text-braidot-negro mb-6">Acciones Rápidas</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <button className="group bg-gradient-to-br from-braidot-gris to-braidot-gris2 hover:from-braidot-gris2 hover:to-braidot-gris text-white p-6 rounded-xl transition-all duration-300 text-left shadow-lg hover:shadow-2xl transform hover:scale-105">
              <div className="flex items-center gap-3 mb-2">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              ...
              <p className="text-sm text-white/90">Gestionar calendario de quintas</p>
            </button>
